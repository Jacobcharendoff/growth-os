        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl border-2 border-rose-600 p-8 text-left shadow-lg relative">
              ...
              <Link href="/login?tab=signup" className="block w-full px-6 py-3 rounded-xl bg-rose-600 text-white text-sm font-semibold hover:bg-rose-700 transition-colors text-center mb-6">Start Free Trial</Link>
              <ul className="space-y-3 text-sm text-gray-700">
