      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-5 sm:p-8 md:p-12 shadow-sm prose prose-lg max-w-none">
            ...
            <p>
              By accessing or using Staybookt, you agree to be bound by these Terms. If you do not agree to any part of these Terms, you may not use the Service.
            </p>

            <h2>2. Service Description</h2>
            <p>
              Staybookt is a cloud-based CRM platform designed to help service businesses manage customer relationships, scheduling, invoicing, and business operations. The Service includes features such as contact management, job scheduling, invoicing, and reporting tools.
            </p>
            <p>
            ...
            <p>
              When you create an account with Staybookt, you agree to:
            </p>
            <ul>
            ...
            <p>
              Staybookt is provided on a subscription basis. All fees are stated in Canadian Dollars (CAD).
            </p>
            <ul>
            ...
            <p>
              You may cancel your Staybookt subscription at any time. Cancellation will take effect at the end of your current billing period. No refunds will be issued for the portion of the billing period after cancellation.
            </p>
            <p>
            ...
            <p>
              "User Content" refers to any data, files, or information you input into Staybookt, including customer information, job details, invoices, and communications.
            </p>
            <ul>
              <li><strong>Ownership:</strong> You retain full ownership of your User Content</li>
              <li><strong>License to Staybookt:</strong> You grant us a worldwide, non-exclusive license to use, store, and process your User Content solely to provide the Service</li>
            ...
            <p>
              The Staybookt Service, including all software, documentation, design, graphics, and other materials, are the exclusive property of Staybookt Inc. and are protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, STAYBOOKT INC. WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>
            <p>
            ...
            <p>
              STAYBOOKT IS PROVIDED ON AN "AS-IS" AND "AS-AVAILABLE" BASIS. WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
            </p>
            <p>
            ...
            <p>
              You agree to indemnify and hold harmless Staybookt Inc., its officers, employees, and agents from any claims, damages, losses, or expenses (including legal fees) arising out of:
            </p>
            <ul>
            ...
            <p>
              These Terms, together with our Privacy Policy and any other agreements you have entered into with us, constitute the entire agreement between you and Staybookt Inc. and supersede all prior and contemporaneous agreements, understandings, and negotiations.
            </p>
            ...
            <ul>
              <li><strong>Email:</strong> hello@staybookt.ca</li>
